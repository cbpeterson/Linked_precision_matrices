...
[C_save, Sig_save, adj_save, Phi_save, ar_Phi] = ...
    MCMC_linked_precision_matrices(S, [n1, n2, n3, n4], C, Phi, ...
...
[C_save_resample, Sig_save_resample] = ...
    MCMC_resample_C_for_fixed_graph(median_model, S, [n1, n2, n3, n4], C, est_Phi, ...
...
csvwrite('./Case_study/Output/hpHC.csv',ppi(:,:,1))
csvwrite('./Case_study/Output/HC.csv',ppi(:,:,2))
csvwrite('./Case_study/Output/MCI.csv',ppi(:,:,3))
csvwrite('./Case_study/Output/AD.csv',ppi(:,:,4))

%% save est_Phi %%
csvwrite('./Case_study/Output/est_Phi.csv',est_Phi)
