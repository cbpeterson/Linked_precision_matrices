function [C_save, Sig_save, adj_save] = ...
  MCMC_sep_precision_matrices(S, n, C, v0, v1, lambda, pii, ...
      burnin, nmc, disp)
% Separate estimation using mixture priors for each of the K groups
...
% Fix Phi to be identity matrix so that estimation is really just separate
% estimation
Phi = eye(K);
